# discordbotstut
# Внимание! Не воспринимайте данный туториал всерьёз. Он является шуточным и не имеет практического применения. 
# Весь код в этом репозитории не соответствует базовым стандартам JS, так как я сам его не знаю.
